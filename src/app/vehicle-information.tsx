...
const styles = StyleSheet.create({
  ...
  selectorValue: { color: '#202020', fontSize: 15 },
  ...
  optionText: { color: '#505A6A', fontSize: 12, fontWeight: '500' },
  ...
  dateValue: { color: '#202020', fontSize: 15 },
  primaryButton: {
    minHeight: 50,
    borderRadius: 12,
  ...
  infoText: { color: '#F1B900', fontSize: 13, fontWeight: '600' },
  dateDismissButton: {
    position: 'absolute',
    right: 20,
    bottom: 20,
