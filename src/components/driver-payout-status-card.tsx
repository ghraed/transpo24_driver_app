...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 16, fontWeight: '700', color: '#202020' },
  headline: { fontSize: 14, fontWeight: '600', color: '#202020' },
  details: { fontSize: 13, color: '#707A8C' },
  metaText: { fontSize: 12, color: '#707A8C' },
  amountText: { fontSize: 20, fontWeight: '700', color: '#202020' },
  ...
  secondaryButtonText: { color: '#505A6A', fontWeight: '700', fontSize: 12 },
  primaryButton: {
    minHeight: 44,
    borderRadius: 10,
